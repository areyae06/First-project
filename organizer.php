      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_organizer.php" class="btn btn-primary" name="save" value="create">
                  Create Organizer
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:red;"><b>Organizer List</h3></div></b>
              <div class="col-sm-4">
...
$sql = "SELECT * FROM organizers ORDER BY id";
...
$sql = "SELECT * FROM organizers ORDER BY id ASC";
$result = $conn->query($sql);
?>
...
<div>
  <table id="organizerTable" class="table table-bordered table-striped table-hover">
    <thead>
      <tr>
        <th>ID</th>
      ...
      <?php if ($result->num_rows > 0): ?>
        <?php while($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td><a href="edit_organizer.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a></td>
            <td><a href="delete_organizer.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this organizer?');">Delete</a></td>
          </tr>
        <?php endwhile; ?>
      <?php else: ?>
        <tr><td colspan="5" class="text-center text-danger">No organizers found.</td></tr>
      <?php endif; ?>
    </tbody>
  </table>
</div>
