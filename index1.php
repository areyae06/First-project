...
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    echo '<h2 style="color:red; text-align: center;">Unauthorized access. Please <a href="index.html">Login</a></h2>';
    exit();
}
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./forms/organizer.php" class="nav-link">
                  <p>Organizers</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="./forms/participant.php" class="nav-link">
                  <p>Participants</p>
                </a>
              </li>
              <li class="nav-item">
