...
<html lang="en">
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="color:darkmagenta;"><b>Venue</h3></div></b>
              <div class="col-sm-6">
  ...
  <div class="card-body" style="background-color:#fadbd8;">
    <form action="insert_venue.php" method="POST" class="mb-4">
      <div class="mb-3">
        <label class="form-label fw-semibold text-dark">Venue Name</label>
        <input type="text" class="form-control rounded-3 shadow-sm" name="venue_name" required>
      </div>
      <div class="mb-3">
        <label class="form-label fw-semibold text-dark">Address</label>
        <textarea class="form-control rounded-3 shadow-sm" name="address" rows="2" required></textarea>
      </div>
