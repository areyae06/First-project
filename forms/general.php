          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../forms/event.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Event</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/eventtype.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Event Type</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/organizer.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Organizer</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/participant.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Participants</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/venue.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Venue</p>
                    </a>
                  </li>
