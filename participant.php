      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_participant.php" class="btn btn-primary" name="save" value="create">
                  Create Register
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:blue">Participant List</h3></div>
              <div class="col-sm-4">
...
$sql = "SELECT p.id, p.participant_name, p.email, p.phone, e.event_name
        FROM participants p
...
<head>
  ...
  <style>
    .custom-table {
      ...
      background-color: #f0f9ff; /* Light blue table background */
    }
    .custom-table th,
    .custom-table td {
    ...
    .dataTables_wrapper .dataTables_length {
      background-color: #e9f5ff; /* Light background for entries/search */
      padding: 10px;
      border-radius: 8px;
      margin-bottom: 10px;
    }
...
<body class="p-4 bg-light">
  ...
  <div class="container">
    ...
    <table id="participantTable" class="table table-bordered table-striped table-hover custom-table">
     <thead>
  <tr>
    <th>ID</th>
    <th>Name</th>
  ...
  <td class="text-center">
    <a href="edit_participant.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning me-1">Edit</a></td>
    <td>
    <a href="delete_participant.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this participant?');">Delete</a>
  </td>
</tr>
