      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_event.php" class="btn btn-primary" name="save" value="create">
                  Create Events
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:#0d6efd;"><b>Events</h3></div></b>
              <div class="col-sm-4">
...
$sql = "SELECT events.*, event_types.name AS event_type 
        FROM events 
...
<head>
  ...
  table.dataTable tbody tr:nth-child(even) {
    background-color: #fff2e0; /* alternating row color */
  }
...
<tbody>
  <?php while ($row = $result->fetch_assoc()) { ?>
    <tr>
      ...
      <td>
  <a href="edit_event.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning me-1">
    Edit
  </a>
</td>
<td>
