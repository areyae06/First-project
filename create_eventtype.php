...
<html lang="en">
 ...
 <style>
  .form-card {
    background-color: #fff3cd; /* Warm light yellow */
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0" style="color:darkblue;"><b>Event type</h3></div></b>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="form-card">
           <form action="insert_event_type.php" method="post">
    <div class="mb-3">
      <label for="name" lass="form-label" >Event Type Name</label>
      <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Conference" required>
    </div>
