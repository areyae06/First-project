      ...
      <main class="app-main">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <a href="create_venue.php" class="btn btn-primary" name="save" value="create">
                  Create Venue
                </a>
              </div>
            </div>
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-8"><h3 class="mb-0" style="color:#78281f;">Venue List </h3></div>
              <div class="col-sm-4">
...
$sql = "SELECT * FROM venues ORDER BY id ASC";
        ...
        <?php if ($result->num_rows > 0): 
          while ($row = $result->fetch_assoc()): ?>
            <tr>
              ...
              <td>
                <a href="edit_venue.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
              </td>
              <td>
                <a href="delete_venue.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this venue?');">Delete</a>
              </td>
            </tr>
        <?php endwhile; else: ?>
          <tr><td colspan="5" class="text-center text-danger">No venues found.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
